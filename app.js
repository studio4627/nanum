...
function renderTopic1(){
  byId('topicContent').innerHTML = `
    ...
    ${personPanel('창세기 그룹 - 야곱','cream','jacob',[
      ['창세 25,27','이 아이들이 자라서, 에사우는 솜씨 좋은 사냥꾼 곧 들사람이 되고, 야곱은 온순한 사람으로 천막에서 살았다.'],
      ['창세 25,29','하루는 야곱이 죽을 끓이고 있었다. 그때 에사우가 허기진 채 들에서 돌아왔다.'],
      ['창세 25,30','에사우가 야곱에게 “허기지구나. 저 붉은 것, 그 붉은 것 좀 먹게 해 다오.” 하고 말하였다. 그리하여 그의 이름을 에돔이라 하였다.'],
    ...
    ${personPanel('탈출기 그룹 - 모세','sage','moses',[
      ...
      ['탈출 4,1', '모세가 대답하였다. “그들이 저를 믿지 않고 제 말을 듣지도 않으면서, ‘주님께서 당신에게 나타나셨을 리가 없소.’ 하면 어찌합니까?”'],
      ['탈출 4,10','“저는 말솜씨가 없는 사람입니다.”'],
      ['탈출 9,29','모세가 그에게 말하였다. “제가 성읍을 나서는 대로 주님께 제 손을 펼치겠습니다. 그러면 우레가 멎고 우박이 더 이상 내리지 않을 것입니다. 이는 세상이 주님께 속한다는 것을 임금님께서 아시게 하려는 것입니다.'],
